...
3. 视频开头出现了一个球状透明生物，体表有白色凸起
视觉引导：请在脑海中构建一个画面：视频最开始，一个近乎全透明的球状生物悬浮在深暗的海水中。球体表面分布着白色的凸起结构，从球体表面向外隆起，在透明躯体的映衬下清晰可见。
语言引导：请记住这个要点：视频最先出现的生物形态与特征——球状、近乎透明、体表带有白色凸起。
...
8. 视频最后出现的蓝色光芒呈现一明一暗的闪烁状态
视觉引导：请在脑海中构建一个画面：在视频最后的漆黑深海的背景中，一道蓝色光芒亮起。光线并非稳定持续，而是以固定周期交替增强和减弱，在黑暗水体中形成规律性的亮度波动。
语言引导：请记住这个要点：视频最后的蓝色光芒的发光动态——光线呈现一明一暗的闪烁状态。
...
17. 条状生物以S型姿势向上游动并离开画面
视觉引导：请在脑海中构建一个画面：条状生物的身体弯折成S形曲线，通过左右交替的扭动快速向上游动，随后移出画面范围。
语言引导：请记住这个要点：条状生物的运动方式——身体呈S形弯曲，快速向上游动并离开画面。
...
语言引导：请记住这个要点：蜘蛛状生物的步足数量——该生物共有8条步足。
